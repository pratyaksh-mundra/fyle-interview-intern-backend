...
class Assignment(db.Model):
    ...
    def submit(cls, _id, teacher_id, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(assignment.state==AssignmentStateEnum.DRAFT or assignment.state==AssignmentStateEnum.GRADED ,'Only a draft assignment can be submitted') #to
        assertions.assert_found(assignment, 'No assignment with this id was found')
